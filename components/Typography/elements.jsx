...
export const StyledSectionHeadingCard = styled(forwardRef((props, ref) => <h3 {...props} ref={ref} />))`
  font-family: Poppins;
  font-size: 1rem;
  font-weight: 600;
  margin: 0;
...
export const StyledSectionInnerHeading = styled(forwardRef((props, ref) => <span {...props} ref={ref} />))`
  font-family: Poppins;
  font-size: 0.75rem;
  // line-height: 1.5rem;
  font-weight: 600;
